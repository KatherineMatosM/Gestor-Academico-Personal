...
export default function AuthScreen({ onAuth }) {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: `linear-gradient(135deg, ${C.coffee} 0%, #071829 100%)` }}>
      <div style={{ display: "flex", width: 780, maxWidth: "95vw", minHeight: 460, borderRadius: 20, overflow: "hidden", boxShadow: "0 25px 60px rgba(0,0,0,0.35)" }}>
        ...
        {/* Left Panel */}
        <div style={{ width: "38%", minWidth: "38%", background: `linear-gradient(160deg, ${C.orchid} 0%, ${C.orchidDark} 55%, ${C.coffee} 100%)`, position: "relative", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 32 }}>
          <div style={{ position: "absolute", top: -40, left: -40, width: 160, height: 160, background: `${C.orchidLight}40`, borderRadius: "0 0 50% 0", transform: "rotate(15deg)" }} />
          <div style={{ position: "absolute", bottom: -30, right: -30, width: 130, height: 130, background: `${C.sugar}30`, borderRadius: "50% 0 0 0", transform: "rotate(-10deg)" }} />
          <div style={{ position: "absolute", top: "45%", left: "10%", width: 80, height: 80, border: `2px solid ${C.sugar}50`, borderRadius: 12, transform: "rotate(25deg)" }} />
          <div style={{ position: "absolute", top: "20%", right: "15%", width: 50, height: 50, background: `${C.sky}30`, borderRadius: "50%" }} />
